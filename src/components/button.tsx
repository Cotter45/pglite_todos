...
type ButtonProps = (
  | Omit<Headless.ButtonProps, "className" | "href" | "onCopy"> // Button-specific props
  | Omit<React.ComponentPropsWithoutRef<typeof Link>, "className" | "onCopy">
) & {
  // Link-specific props
  ...
  href?: string; // When href is present, we render an anchor
};
...
export const Button = forwardRef(function Button(
  ...
  return (
    <Headless.Button
      {...(props as Omit<Headless.ButtonProps, "onCopy">)} // Apply button-specific props
